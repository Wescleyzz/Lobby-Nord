...
public class TournamentInventory {
    ...
    private static final ItemStack INFO = new ItemBuilder().type(Material.BOOK).name("§aComo funciona!").lore("", "§7Todas informações estão no", "§7discord do torneio: §f" + Constants.DISCORD).build();
    private static final ItemStack REWARD = new ItemBuilder().type(Material.GOLD_INGOT).name("§aPremiação").lore("", "§a1° - §aMouse Razer Deathadder 2013", "§e2° - §aMinecraft FA", "§c3° - §aCapa optifine", "§c4° - §aMinecraft SFA", "§c5° - §aSaint Eterno").build();
